...
<section class="content">
    <div class="container">
        ...
        <form action="" method="POST">
            <!-- Название банка -->
            <div class="card mb-4">
                <h5 class="card-header">Название банка</h5>
                <div class="card-body">
                        ...
                        <?php foreach (['ru', 'en', 'am'] as $lang): ?>
                            <div class="tab-pane fade<?= $lang === 'ru' ? ' show active' : '' ?>" id="bank_name_<?= $lang ?>">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="bank[name][<?= $lang ?>]" value="<?= htmlspecialchars($bank['name'][$lang] ?? '') ?>">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <div class="accordion" id="branchesAccordion">
                <?php $i = 0; foreach ($bank['baranches'] as $key => $branch): ?>
